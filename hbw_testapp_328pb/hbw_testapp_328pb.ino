/*
 * HBW-Test-App (ATmega328PB)  —  App-Seite fuer den HBW-Booter, 328PB-Portierung
 * -----------------------------------------------------------------------------
 * Wie hbw_testapp (328P), aber fuer den ATmega328PB. Normale App-Section (0x0000),
 * spricht das HMW-Wire-Protokoll (Announce, h/v/n, z/Z). Auf 'u' (START_BOOTER):
 * ACK + ECHTER Watchdog-Reset  ->  der Booter (@0x7000) uebernimmt.
 *
 * Zweck: Erst-Test des 328PB-Booters ueber USB-Serial (ohne RS485/CCU) -- exakt der
 ...
 *
 * BUILD (arduino-cli, MiniCore) -- 328PB-Variant, ohne Bootloader (eigene Fuses):
 *   arduino-cli compile --fqbn MiniCore:avr:328:variant=modelPB,clock=16MHz_external,bootloader=no_bootloader \
 *       hbw_testapp_328pb
 * Danach mit dem Booter zu einer ISP-Datei mergen:
 *   python merge_hex.py hbw_testapp_328pb.hex hbw_booter_atmega328pb.hex hbw_combined_328pb.hex
 *
