/*
 * HBW-Test-App (ATmega32A)  —  App-Seite fuer den HBW-Booter, 32A-Portierung
 * -----------------------------------------------------------------------------
 * Wie hbw_testapp (328P), aber fuer den ATmega32A. Normale App-Section (0x0000),
 ...
 *
 * Zweck: Erst-Test des 32A-Booters ueber USB-Serial (ohne RS485/CCU) -- exakt der
 ...
 *   arduino-cli compile --fqbn MightyCore:avr:32:clock=16MHz_external,bootloader=no_bootloader \
 *       hbw_testapp_32
 * Danach mit dem Booter zu einer ISP-Datei mergen:
 *   python merge_hex.py hbw_testapp_32.hex hbw_booter_atmega32.hex hbw_combined_32.hex
 *
